(() => {
  ...
  const css = `
    ...
    .ijf-section{display:grid;gap:16px}.ijf-section+.ijf-section{margin-top:46px}.ijf-section-title{position:relative;margin:0 0 12px!important;padding:0 0 0 18px;background:linear-gradient(110deg,#0aa8ed,#5b67f6 52%,#c843ed);-webkit-background-clip:text;background-clip:text;color:transparent!important;font-family:inherit!important;font-size:24px!important;font-weight:900!important;line-height:1.15!important;letter-spacing:0!important;text-align:left!important;text-transform:uppercase!important}.ijf-section-title:before{content:"";position:absolute;left:0;top:.08em;width:6px;height:1.05em;border-radius:999px;background:linear-gradient(180deg,#25c7dc,#3ea4e6)}
