(() => {
  ...
  function mount(target) {
    ...
    target.innerHTML = `<div class="ijf-root"><style>${css}</style><div class="ijf-toolbar"><label class="ijf-search">${iconSvg("search")}<input type="search" placeholder="Search jobs" aria-label="Search jobs"></label><div class="ijf-count" data-role="count"></div></div><div class="ijf-list" data-role="list"><div class="ijf-skeleton"></div><div class="ijf-skeleton"></div></div><div class="ijf-modal" data-role="modal" hidden><div class="ijf-modal-backdrop" data-modal-close></div><section class="ijf-dialog" role="dialog" aria-modal="true" aria-labelledby="ijf-modal-title" tabindex="-1"><header class="ijf-dialog-head"><div class="ijf-dialog-kicker">${iconSvg("briefcase")} Job details</div><h2 class="ijf-dialog-title" id="ijf-modal-title" data-role="modal-title">Job opening</h2><p class="ijf-dialog-company" data-role="modal-company"></p><button class="ijf-close" type="button" data-modal-close aria-label="Close job details">${iconSvg("close")}</button></header><div class="ijf-dialog-scroll" data-role="modal-body"><div class="ijf-detail-status">Loading job details…</div></div></section></div></div>`;
