(() => {
  ...
  const css = `
    ...
    .ijf-head{display:flex;align-items:center;gap:10px;min-width:0}.ijf-type{display:inline-flex;flex:none;align-items:center;border-radius:999px;background:linear-gradient(90deg,#f59e0b,#facc15 58%,#ff8a00);padding:6px 11px;color:#fff;font-size:10px;font-weight:800;letter-spacing:.04em;text-transform:uppercase;box-shadow:0 5px 12px -8px #f97316}.ijf-type--sky{background:linear-gradient(90deg,#58d0d8,#3ea4e6);box-shadow:0 5px 12px -8px #0284c7}.ijf-type--violet{background:linear-gradient(90deg,#8b5cf6,#c084fc);box-shadow:0 5px 12px -8px #7c3aed}.ijf-type--emerald{background:linear-gradient(90deg,#22c55e,#14b8a6);box-shadow:0 5px 12px -8px #059669}.ijf-title{margin:0;min-width:0;font-size:20px;line-height:1.18;font-weight:800;letter-spacing:-.015em;color:var(--ijf-ink)}
