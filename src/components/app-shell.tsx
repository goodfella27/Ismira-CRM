  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-950">
      ...
      <div className="flex min-h-screen min-w-0 flex-1 p-4 sm:p-6 lg:p-8">
        <div className="flex min-h-full w-full flex-col overflow-hidden rounded-3xl bg-white shadow-[0_20px_60px_-40px_rgba(15,23,42,0.4)] ring-1 ring-slate-200/70">
          <MobileTopNav />
